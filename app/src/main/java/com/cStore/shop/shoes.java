...
public class shoes extends AppCompatActivity implements RecyclerViewClickListener {
    ...
    private class SigninActivity extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                ...
                String link = "https://c-store.000webhostapp.com/products.php?id=7";
        ...
        public void onPostExecute(String result2) {
            ...
            try {
                ...
                RecyclerView.LayoutManager layoutManager = new GridLayoutManager(shoes.this,3);
                ...
                home_adapter = new Home_Adapter(shoes.this, shoes.this,home_model);
