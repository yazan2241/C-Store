...
public class trouser extends AppCompatActivity implements RecyclerViewClickListener {
    ...
    private class SigninActivity extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                ...
                String link = "https://c-store.000webhostapp.com/products.php?id=4";
        ...
        public void onPostExecute(String result2) {
            ...
            try {
                ...
                RecyclerView.LayoutManager layoutManager = new GridLayoutManager(trouser.this,3);
                ...
                home_adapter = new Home_Adapter(trouser.this, trouser.this,home_model);
