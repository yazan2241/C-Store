...
public class shirt extends AppCompatActivity implements RecyclerViewClickListener {
    ...
    public void onPostExecute(String result2) {
        ...
        try {
            ...
            RecyclerView.LayoutManager layoutManager = new GridLayoutManager(shirt.this,3);
            ...
            home_adapter = new Home_Adapter(shirt.this, shirt.this,home_model);
