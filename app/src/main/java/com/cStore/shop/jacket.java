...
public class jacket extends AppCompatActivity implements RecyclerViewClickListener {
    ...
    private class SigninActivity extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                ...
                String link = "https://c-store.000webhostapp.com/products.php?id=5";
        ...
        public void onPostExecute(String result2) {
            ...
            try {
                ...
                RecyclerView.LayoutManager layoutManager = new GridLayoutManager(jacket.this,3);
                ...
                home_adapter = new Home_Adapter(jacket.this, jacket.this,home_model);
