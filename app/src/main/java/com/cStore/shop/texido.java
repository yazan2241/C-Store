...
public class texido extends AppCompatActivity implements RecyclerViewClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_texido);
    ...
    private class SigninActivity extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                ...
                String link = "https://c-store.000webhostapp.com/products.php?id=1";
        ...
        public void onPostExecute(String result2) {
            ...
            try {
                ...
                RecyclerView.LayoutManager layoutManager = new GridLayoutManager(texido.this,3);
                ...
                home_adapter = new Home_Adapter(texido.this, texido.this,home_model);
